  ...
  return (
    <div className="flex flex-col gap-4">
      <label className="flex flex-col gap-1">
        ...
        <select
          value={config.script}
          onChange={(event) => onChange({ script: event.target.value as DafYomiConfig["script"] })}
      ...
      <label className="flex flex-col gap-1">
        ...
        <select
          ...
          onChange={(event) => onChange({ numerals: event.target.value as DafYomiConfig["numerals"] })}
      ...
      <label className="flex flex-col gap-1">
        ...
        <select
          value={config.align}
          onChange={(event) => onChange({ align: event.target.value as DafYomiConfig["align"] })}
          className={PANEL_CONTROL}
        >
