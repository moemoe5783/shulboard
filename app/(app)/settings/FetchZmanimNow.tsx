 ...
 * rather than a checkmark — or the provider's own error verbatim. The
 * window is 92 days (WARM_DAYS in lib/zmanim/warm.ts), so "through
 * December 10. 92 days, 14 with candle lighting." is the expected shape of
 * the answer.
 *
    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-3">
        ...
        <p className="text-meta text-ink-soft">
          Reads about three months of zmanim and candle lighting from
          chabad.org for the saved ZIP. Anything beyond that is calculated
          instead. This runs on its own once a day; use this to check it
          works, or after changing the ZIP.
        </p>
      </div>
